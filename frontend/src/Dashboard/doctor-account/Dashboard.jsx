                    ...
                    <div className="lg:col-span-2">
                        ...
                        rounded-lg">
                             <svg 
                                ...
                                <path 
                                    fillRule="evenodd"
                                    d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-12 0 1 1 0 012 0zM9 9a1 1 0 000
                            ...
                            {tab==='overview' && ( <div>
                                <div className="flex items-center gap-4 mb-10">
                                    ...
                                    <div>
                                        ...
                                        lg:py-6 rounded text-[12px] leading-4 lg:text-[16px] lg:leading-6
                                        font-semibold">{data.specialization}
                                        </span>
