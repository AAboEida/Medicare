...
const Profile = ({doctorData}) => {
    ...
    const addQualification = e =>{
        e.preventDefault();
        addItem("qualifications", {startingDate:"",endingDate:"", degree:"PHD", university:"Menoufia Medical College"});
    }
    ...
    const addExperience = e =>{
        e.preventDefault();
        addItem("experiences", 
        {startingDate:"",endingDate:"", position:"Senior Sergeon", hospital:"Menoufia Medical College"});
    }
  ...
  return ( <div>
    ...
    <form>
             ...
             <div key={index}>
                <div>
                    <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5 ">
                        <div>                       
                            ...
                            {/* <input type="date" name="startingDate" 
                                ...
                                >
                                    ...
                                    <option value="wednseday">Wednesday</option>
                        ...
                        className="bg-red-600 p-2 rounded-full text-white text-[18px] cursor-pointer mt-14">
                        <AiOutlineDelete/>
                        </button>
        ...
        <div className="mb-5">
            ...
            <textarea name="about" value={formData.about} raws={5} placeholder="Write about you" onChange=
            {handleInputChange}className="form__input"></textarea>
        </div>
    ...
    <div className="mt-7">
        ...
        w-full py-3 px-5 rounded-lg">Update Profile</button>
